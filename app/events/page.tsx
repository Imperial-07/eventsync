...
export default function EventsPage() {
  ...
  const categories = ["all", "Technology", "Design", "Business", "Networking"];
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {filteredEvents.map((event) => {
            ...
            return (
              <Card
                key={event.id}
                className="flex flex-col group hover:shadow-[0_0_40px_rgba(59,130,246,0.5)] hover:-translate-y-2 transition-all duration-300 ease-out cursor-pointer"
              >
                <CardHeader>
